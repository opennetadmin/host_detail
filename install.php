...
$plugin_name = 'host_detail';

// Set a title
$window['title'] = "Host Detail Install";
...
//
$pmodules = array();
$pmodules['host_detail']['desc'] = 'Display detailed host data in various formats';
$pmodules['host_detail']['file'] = "..{$plugindir}/{$plugin_name}.inc.php";
